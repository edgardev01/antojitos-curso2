...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-12-2024 a las 05:41:00
...
INSERT INTO `pagos` (`id_pago`, `id_cliente`, `total`, `fecha_pago`, `estado`) VALUES
(1, 1, 18.00, '2024-12-16 22:01:51', 'Completado'),
(2, 1, 18.00, '2024-12-16 22:04:31', 'Completado'),
(3, 1, 18.00, '2024-12-16 22:07:01', 'Completado'),
(4, 1, 18.00, '2024-12-16 22:07:04', 'Completado'),
(5, 1, 18.00, '2024-12-16 22:09:53', 'Completado'),
(6, 1, 18.00, '2024-12-16 22:12:22', 'Completado'),
(10, 1, 27.00, '2024-12-16 22:20:55', 'Completado'),
(11, 3, 18.00, '2024-12-16 22:34:33', 'Completado');
...
INSERT INTO `pedidos` (`id_pedido`, `fecha_hora`, `estado`, `producto_id`, `nombre_producto`, `cantidad`, `precio`, `categoria`, `id_cliente`) VALUES
(1, '2024-12-16 21:09:46', 'Pendiente', 2, 'Taco de pastor', 1, 9.00, 'Taco', 1),
(2, '2024-12-16 21:35:17', 'Pendiente', 1, 'Huarache suadero', 1, 9.00, '', 1),
(3, '2024-12-16 22:18:08', 'Pendiente', 1, 'Taco de suadero', 1, 9.00, '', 1),
(4, '2024-12-16 22:34:22', 'Pendiente', 1, 'Huarache suadero', 1, 9.00, '', 3),
(5, '2024-12-16 22:34:28', 'Pendiente', 2, 'Taco de pastor', 1, 9.00, '', 3);
...
CREATE TRIGGER `verificar_horario_pedido` BEFORE INSERT ON `pedidos` FOR EACH ROW BEGIN
    ...
    -- Permitir pedidos entre 9:00 AM - 11:59 PM o entre 12:00 AM - 4:00 AM
    IF NOT ((hora_actual BETWEEN '09:00:00' AND '23:59:59') OR (hora_actual BETWEEN '00:00:00' AND '04:00:00')) THEN
        SIGNAL SQLSTATE '45000'
